        ...
        this.model = [
            {
                ...
                items: [
                    {label: 'Dashboard', icon: 'pi pi-chart-bar', routerLink: ['/main/mydashboard']},
                    {label: 'Depense', icon: 'pi pi-euro', routerLink:['/main/depense']},
                    {label: 'Recette', icon: 'pi pi-euro', routerLink:['/main/recette']},
                    {label: 'Banking', icon: 'pi pi-wallet', routerLink:['/main/depense-banking']},
                    {label: 'Paied', icon:'pi pi-fw pi-check-square', routerLink:['/main/banque']},
            ...
            {
                //  label: 'Utilities', icon: 'pi pi-fw pi-compass', routerLink: ['/main/utilities'],
                //  items: [
